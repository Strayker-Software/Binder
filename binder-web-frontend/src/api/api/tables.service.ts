...
export class TablesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiTablesPost(tableName?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<DefaultTable>;
    public apiTablesPost(tableName?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<DefaultTable>>;
    public apiTablesPost(tableName?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<DefaultTable>>;
    public apiTablesPost(tableName?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/api/tables`;
        return this.httpClient.request<DefaultTable>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
